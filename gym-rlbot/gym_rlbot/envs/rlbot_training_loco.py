...
class RLBOT_loco(object):

    def __init__(self, mode):
        print ('Creating gym environment...')
        self.env = gym.make('rlbot-v2')
    ...
    def train(self, num_frames):
        ...
        predict_movement_angular,_ = self.deep_q.predict_movement(curr_state, epsilon)
        temp_observation, temp_reward, done, _ = self.env.step([-8])
        self.env.reset()
        ...
        while observation_num < num_frames:
            ...
            temp_observation, temp_reward, done, _ = self.env.step([predict_movement_angular])
            ...
            self.replay_buffer.add(curr_state, predict_movement_angular, temp_reward, done, new_state)
